...
public class BoardControllerTests {
	...
	public void testModify() throws Exception {
		...
		String resultPage = mockMvc
				.perform(MockMvcRequestBuilders.post("/review/modify").param("bno", "1").param("title", "수정된 테스트 새글 제목")
	...
	public void testRemove() throws Exception {
		...
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/review/remove").param("bno", "2")).andReturn()
