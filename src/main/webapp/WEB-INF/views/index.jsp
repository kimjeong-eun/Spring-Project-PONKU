...
<section class="categories" style="max-width: 1500px; height: 470px; margin: 190px auto 80px;">
   <div class="container" style="">
      <div class="row">
      <div class="section-title from-blog__title">
            <h2 style="font-size: 2rem;">Trending Designs!</h2>
         </div>
...
<!-- Blog Section Begin -->
<section class="from-blog spad" style="max-width: 1500px; margin: 0 auto; margin-bottom: 160px;">
   <div class="container">
      <div class="row">
         <div class="section-title from-blog__title">
            <h2 style="font-size: 2rem;">From The Blog</h2>
         </div>
